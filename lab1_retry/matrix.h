...
void MatrixCreate(MatrixCollection *collection, Matrix **matrix, char *name, size_t size, FieldInfo *element_type, int *response);      //3

void MatrixAutoCreate(MatrixCollection *collection, Matrix **matrix, char *name, size_t size, FieldInfo *element_type, int *response, void *max_number);  //3

void MatrixRename(MatrixCollection *collection, char *name_1, char *name_2); //4

void MatrixAdd(Matrix **m_sum, Matrix **m_1, Matrix **m_2, int *response, MatrixCollection *collection, char *name);  //5

void MatrixMultiply(Matrix **m_product, Matrix **m_1, Matrix **m_2, int *response, MatrixCollection *collection, char *name);  //6
